package cn.btrees.jhip02.web.rest;
...
import cn.btrees.jhip02.IntegrationTest;
import cn.btrees.jhip02.domain.Customer;
import cn.btrees.jhip02.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).enName(DEFAULT_EN_NAME).fullName(DEFAULT_FULL_NAME);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).enName(UPDATED_EN_NAME).fullName(UPDATED_FULL_NAME);
        return customer;
    }
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getEnName()).isEqualTo(DEFAULT_EN_NAME);
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).enName(UPDATED_EN_NAME).fullName(UPDATED_FULL_NAME);
        ...
        assertThat(testCustomer.getEnName()).isEqualTo(UPDATED_EN_NAME);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).enName(UPDATED_EN_NAME).fullName(UPDATED_FULL_NAME);
